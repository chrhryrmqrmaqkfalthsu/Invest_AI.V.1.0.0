...
| Metric | v4 | This run |
|---|---:|---:|
| all3/all2/all1/all0 | 0/2/192/106 | 0/4/238/58 |
| fold별 pass 수 | - | 82/77/87 |
| fold-best 거래수 | 20/15/13(±) | 35/15/15 |
| fold-best EEC | 2.30/2.53/3.70(±) | 6.260870/4.000000/4.454545 |
| fold-best 최대 클러스터 비중 | 60%/60%/37% | 25.00%/33.33%/28.57% |
| fold-best fitness | ? | 0.8626624277408751/1.2864760257082175/1.6912132720375668 |

## Fold-best EEC·클러스터

| fold | 거래수 | 비중복 체결 | EEC | EEC multiplier | 최대 클러스터 비중 | 클러스터 기간·거래수 | entry-time 분포 | active-day 분포 |
|---|---:|---:|---:|---:|---:|---|---|---|
| train_1 | 35 | 0 | 6.260870 | 1.0 | 25.00% | `2022-07-01~2022-07-18:4(16.7%) ; 2022-10-11~2022-10-21:6(25.0%) ; 2022-12-19~2022-12-30:3(12.5%) ; 2023-01-25~2023-01-30:3(12.5%) ; 2023-04-12~2023-04-14:3(12.5%) ; 2023-05-03~2023-05-05:3(12.5%) ; 2023-06-26~2023-06-27:2(8.3%)` | `{"1": 10, "2": 9, "3": 4, "4": 1}` | `{"1": 24, "2": 12, "3": 5, "4": 1}` |
| train_2 | 15 | 0 | 4.000000 | 1.0 | 33.33% | `2023-12-08~2023-12-12:3(25.0%) ; 2024-01-24~2024-01-24:1(8.3%) ; 2024-02-21~2024-02-26:4(33.3%) ; 2024-05-01~2024-05-01:1(8.3%) ; 2024-05-16~2024-05-22:3(25.0%)` | `{"1": 6, "2": 3, "3": 2, "4": 1}` | `{"1": 12, "2": 3, "3": 2, "4": 1}` |
| train_3 | 15 | 0 | 4.454545 | 1.0 | 28.57% | `2024-07-09~2024-07-15:2(28.6%) ; 2024-07-26~2024-07-26:1(14.3%) ; 2024-08-12~2024-08-13:2(28.6%) ; 2024-11-08~2024-11-08:1(14.3%) ; 2025-04-16~2025-04-16:1(14.3%)` | `{"1": 6, "2": 1}` | `{"1": 11, "2": 2}` |
...
|---|---|---:|---:|---:|---:|---:|
| train_1 | `None` | 6.218274 | 1.000000 | 100 | 100 | 0 |
| train_1 | `None` | 6.218274 | 1.000000 | 100 | 100 | 0 |
| train_1 | `None` | 6.218274 | 1.000000 | 100 | 100 | 0 |
| train_1 | `None` | 6.218274 | 1.000000 | 100 | 100 | 0 |
| train_1 | `None` | 6.218274 | 1.000000 | 100 | 100 | 0 |
| train_2 | `None` | 4.245283 | 1.000000 | 100 | 100 | 0 |
| train_2 | `None` | 4.245283 | 1.000000 | 100 | 100 | 0 |
| train_2 | `None` | 4.245283 | 1.000000 | 100 | 100 | 0 |
| train_2 | `None` | 4.245283 | 1.000000 | 100 | 100 | 0 |
| train_2 | `None` | 4.245283 | 1.000000 | 100 | 100 | 0 |
| train_3 | `None` | 6.818182 | 1.000000 | 100 | 100 | 0 |
| train_3 | `None` | 6.250000 | 1.000000 | 100 | 100 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| train_1 | 300 | 82 | 198 (66.00%) | 0 (0.00%) | 4.318724 | 1.000000 | `{"12_19": 26, "20_80": 256, "8_11": 6, "gt_80": 7, "lt_8": 5}` / `{"12_19": 3, "20_80": 79}` |
| train_2 | 300 | 77 | 202 (67.33%) | 0 (0.00%) | 3.580322 | 1.000000 | `{"12_19": 160, "20_80": 128, "8_11": 7, "gt_80": 3, "lt_8": 2}` / `{"12_19": 60, "20_80": 15, "8_11": 2}` |
| train_3 | 300 | 87 | 205 (68.33%) | 0 (0.00%) | 4.483536 | 1.000000 | `{"12_19": 86, "20_80": 211, "8_11": 3}` / `{"12_19": 25, "20_80": 62}` |
