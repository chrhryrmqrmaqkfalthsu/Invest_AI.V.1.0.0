...
- 2026-06-28 `14005e7` — feat/next-open-buy-timing: central/next_open pending 정산 metadata 누락·손상 시 ticker fallback을 금지하는 fail-closed와 submitted/executed 큐 상태 정확화, Broker 기본 open-order 조회 fail-closed 적용.
